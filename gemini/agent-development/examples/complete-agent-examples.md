...
3. Check adherence to project best practices and coding standards from GEMINI.md
...
5. **Best Practices**:
   - Follow project-specific standards from GEMINI.md
...
- Missing context (no GEMINI.md): Apply general best practices
