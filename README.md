...
build artifacts are committed, that no skill documents a retired model ID, that every `SKILL.md`
stays under 500 lines, and that `gemini/` stays free of Claude terminology. Runs in CI on every
